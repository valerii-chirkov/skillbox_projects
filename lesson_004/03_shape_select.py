...
def triangle(start_point=sd.get_point(250, 250), *, length):
...
def square(start_point=sd.get_point(250, 250), *, length):
...
def pentagon(start_point=sd.get_point(250, 250), *, length):
...
def hexagon(start_point=sd.get_point(250, 200), *, length):
...
if input_shape in shapes_dict:
    ...
    shapes_dict[input_shape][1](length=length)
else:
