...
# TODO Расстояние от Москвы до Лондона равное его обратному направлению
# TODO Расстояние от Парижа до Лондона равно его обратному расстоянию
# TODO Сильно много лишних вычислений
...
# TODO Это замечательно что все упаковано в словарик но это мне кажется лишнее
# TODO Тем более ключ это целое предложение, такого быть не должно нужно упростить
# moscow_distance = {
...
# TODO После корректировок словаря вывод тоже придется переделать
