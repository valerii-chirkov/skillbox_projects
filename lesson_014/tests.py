import unittest
from lesson_014.bowling_refactored import get_score
...
class ScoreTest(unittest.TestCase):
    ...
    def test_equal_score(self):
        result_even_1 = get_score('Xx1234xX')  # 10+10+1 + 10+1+2 + 3 + 7 + 10+10 + 10 = 74
        result_even_2 = get_score('XX9/4-4--3')  # 10+10+9 + 10+10 + 10+4 + 4 + 4 +3 = 74
        self.assertEqual(result_even_1, result_even_2)

        result_even_1 = get_score('Xx12125/5-1-')  # 61
        result_even_2 = get_score('-9-9-9-9-9-9-7')  # 61
        self.assertEqual(result_even_1, result_even_2)
